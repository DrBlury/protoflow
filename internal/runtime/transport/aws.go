...
func createAwsSubscriber(conf *config.Config, logger watermill.LoggerAdapter, cfg *aws.Config) (message.Subscriber, error) {
	...
	snsOpts, sqsOpts, err = addEndpointResolver(cfg, snsOpts, sqsOpts)
	if err != nil {
		return nil, err
	}
...
func addEndpointResolver(cfg *aws.Config, snsOpts []func(*amazonsns.Options), sqsOpts []func(*amazonsqs.Options)) ([]func(*amazonsns.Options), []func(*amazonsqs.Options), error) {
